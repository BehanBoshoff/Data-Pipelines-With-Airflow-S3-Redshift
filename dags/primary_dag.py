...
run_quality_checks = DataQualityOperator(
    ...
    dag=dag,
    redshift_conn_id="redshift",
    tables=[{'name' : 'songplays', 'expected_result': 1 }, 
            {'name' : 'users', 'expected_result': 1 }, 
            {'name' : 'songs', 'expected_result': 1 }, 
            {'name' : 'artists', 'expected_result': 1 }, 
            {'name' : 'time', 'expected_result': 1 }]
)
